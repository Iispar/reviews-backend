...
INSERT INTO words (words_id, words_positive, words_negative) VALUES (3, null, null);

INSERT INTO accounts (account_id, account_email, account_name, account_password, account_userName, account_role) VALUES (1, 'initSeller email', 'initSeller name', 'initSeller pass', 'initSeller username', 1);
INSERT INTO accounts (account_id, account_email, account_name, account_password, account_userName, account_role) VALUES (2, 'initCus email', 'initCus name', 'initCus pass', 'initCus username', 2);
