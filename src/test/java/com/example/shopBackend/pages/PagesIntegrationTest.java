...
class PagesIntegrationTest {
    ...
    void getHomePageWorks() {
        ...
        webClient.get().uri("/api/pages/get/home?accountId=1")
                ...
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.latestReviews.nextPage").isEqualTo(false)
                .jsonPath("$.latestReviews.responseList[0].id").isEqualTo(0)
    ...
    void getItemPageWorks() {
        ...
        webClient.get().uri("/api/pages/get/item?itemId=1")
                ...
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.reviews.nextPage").isEqualTo(false)
                .jsonPath("$.reviews.responseList[0].id").isEqualTo(0)
                .jsonPath("$.chart[0].count").isEqualTo(1)
